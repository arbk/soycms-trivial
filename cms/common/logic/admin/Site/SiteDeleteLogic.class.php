...
class SiteDeleteLogic extends SOY2LogicBase
{
     ...
     * @param id 削除するサイトのID
     */
    public function deleteSite($id, $dropDB = true, $rmDir = true)
    {
     ...
     * データーベースの削除
     */
    public function deleteDataBase($siteId)
    {
     ...
     * 全てのテーブルを削除する
     */
    public function dropAllTable($dsn)
    {
        if (SOYCMS_DB_TYPE != "mysql") {
            return;
        }
...
//      * @param Site site
//      */
//     public function deleteSoyshop($site)
//     {
