...
//              array_push($ret_val, $site);
    ...
    public function getLoginableSiteListByUserId($userId)
    {
     ...
     */
    public function getLoginableSiteIdsByUserId($userId)
    {
        $ids = array();
     ...
     */
    public function createSite($siteId, $siteName, $encoding, $flag = true, $copyFrom = false, $dbType = SOYCMS_DB_TYPE)
    {
        $dao = SOY2DAOFactory::create("admin.SiteDAO");
...
//            $dao->rollback();
     ...
     * @param id 削除するサイトのID
     */
    public function removeSite($id, $dropDB = true, $rmDir = true)
    {
