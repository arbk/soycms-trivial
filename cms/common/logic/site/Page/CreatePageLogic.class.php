...
{
    public function create(Page $page, $tempname = "")
    {
     ...
     */
    public function getPageDAO($pageType = null)
    {
        static $dao;

        if (isset($dao[$pageType])) {
            return $dao[$pageType];
        }
...
//              break;
     ...
     */
    public function getTemplateContents($tempname)
    {
     ...
     * デフォルトのテンプレートを返す
     */
    public function getDefaultTemplateContents($pageType)
    {
        // BlogPageを読み込む
        ...
        switch ($pageType) {
            case Page::PAGE_TYPE_BLOG:
                $contents = array(
                BlogPage::TEMPLATE_TOP => file_get_contents(__DIR__ . "/blog/top.html"),
                BlogPage::TEMPLATE_ENTRY => file_get_contents(__DIR__ . "/blog/entry.html"),
                BlogPage::TEMPLATE_ARCHIVE => file_get_contents(__DIR__ . "/blog/archive.html"),
                );
                break;
  //      case Page::PAGE_TYPE_MOBILE:
  //          $contents = file_get_contents(__DIR__."/mobile_default.html");
  //      break;
            default:
                $contents = file_get_contents(__DIR__ . "/default.html");
                break;
        }
     ...
     */
    public function replaceTitle($contents, $title)
    {
     ...
     */
    public function replaceEncoding($contents)
    {
