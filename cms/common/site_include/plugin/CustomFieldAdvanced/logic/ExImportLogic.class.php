...
class ExImportLogic extends ExImportLogicBase
{
    ...
    public function importFile()
    {
        ...
        $displayLabel = 1;
        $charset = (isset($_POST["format"]["charset"])) ? $_POST["format"]["charset"] : "UTF-8";
    ...
    public function exportFile($fields)
    {
        set_time_limit(EXEC_TIME_NO_LIMIT);
        ...
        header("Content-Disposition: attachment; filename=" . $this->pluginObj->getId() . "_config_" . date("YmdHis", SOYCMS_NOW) . ".csv");
    ...
    public function getLines($fields)
    {
