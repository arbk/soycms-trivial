...
class UploadFileAction extends SOY2Action
{
    ...
    public function execute($response, $form, $request)
    {
        ...
        $fileurl = $this->getSiteUrl() . $this->getDefaultUpload() .  "/". rawurlencode($filename);
...
//          }
    ...
    public function getNextFileName($filename, $counter)
    {
...
class UploadFileActionForm extends SOY2ActionForm
{
    ...
    public function getBeforepath()
    {
        return $this->beforepath;
    }
    public function setBeforepath($beforpath)
    {
        $this->beforepath = $beforpath;
    }

    public function getAlter_name()
    {
        return $this->alter_name;
    }
    public function setAlter_name($alter_name)
    {
