...
class CMSMessageManager
{
    ...
    public static function &getInstance()
    {
        ...
        if (!$_instance) {
            ...
            if ($messages) {
                $_instance->addMessage($messages);
            }
            if ($errors) {
                $_instance->addErrorMessage($errors);
            }
        }
     ...
     */
    public static function addMessageFilePath($filePath)
    {
        $instance = &self::getInstance();
     ...
     */
    public static function addMessageDirectoryPath($directory)
    {
