...
// アイコンのディレクトリ
define("CMS_LABEL_ICON_DIRECTORY", dirname(__DIR__) . "/image/labelicon/");
define("CMS_LABEL_ICON_DIRECTORY_URL", SOY2PageController::createRelativeLink("./image/labelicon/"));
define("CMS_PAGE_ICON_DIRECTORY", dirname(__DIR__) . "/image/pageicon/");
...
//言語別テンプレートディレクトリ
//define("SOYCMS_LANGUAGE_DIR",__DIR__ . "/language/");
