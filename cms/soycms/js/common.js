...
soycms.env = {};
(function () {
    soycms.env.script_name = 'index.php';
    var sIdx = location.pathname.indexOf(soycms.env.script_name);
    soycms.env.script_dir = encodeURI((0 < sIdx) ? location.pathname.substring(0, sIdx) : location.pathname);
    soycms.env.script_path = soycms.env.script_dir + soycms.env.script_name;
})();
