...
class IndexPage extends CMSHTMLPageBase
{
    ...
    public function __construct()
    {
      ...
      // フォームの作成
        ...
        "visible"=>SOY2Logic::createInstance("logic.admin.Administrator.AdministratorLogic")->hasMailAddress() && null!==SOY2Logic::createInstance("logic.mail.MailConfigLogic")->get()
        ));
  ...
  //      ));
        ...
        //auto_loginのチェック
        DisplayPlugin::toggle("auto_login", $this->_isAutoLogin());
    ...
    private function _isAutoLogin()
    {
        ...
        //     return false;    //ASPモードの場合はAutoLoginは利用できない
        // }
